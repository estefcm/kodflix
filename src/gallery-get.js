...
export default function getGallery(){
    return [
      {id:'homeland', name:'react', logo:homeland, details:'Homeland is an American psychological thriller television series developed by Howard Gordon and Alex Gansa, based on the Israeli series Prisoners of War created by Gideon Raff. This wiki is dedicated to the show.'},
